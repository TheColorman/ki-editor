...
- This file defines the fork-specific workflow. Where its version-control instructions conflict with upstream `CLAUDE.md`, follow this file. In particular, the instruction in `CLAUDE.md` to create a branch before committing or opening a PR does not apply to this fork.
- Never create bookmarks in this repository. Use unbookmarked JJ changes for agent work. Do not create a Git branch as a substitute.
- Leave upstream `CLAUDE.md` unchanged when maintaining fork-specific agent instructions.
...
- PR test plans should list only manual testing steps; CI covers automated tests.
